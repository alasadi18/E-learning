...
{
    $id = $_GET['delete'];
    $stm = "DELETE FROM students WHERE id=$id";
...
if(isset($_POST['update']))
{
    ...
    $photo=$_POST['photo'];
    $stm = "UPDATE students SET name='$name',email='$email',phone=$phone,address='$address',photo='$photo' WHERE id=$id";
    mysqli_query($conn,$stm)or die($mysqli->error());
}
...
if(isset($_POST['submit']))
    {
      ...
      $photo=$_POST['photo'];
        ...
        $stm = "INSERT INTO students (name,email,phone,address,photo) VALUES ('$name','$email',$phone,'$address','$photo');";
        try{
               ...
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="log1.php">log in</a>
                        </li>
...
if(!$data)
{
            ...
            while( $category = mysqli_fetch_array($data))
            {
                ?>
                 <tr>
                     ...
                     <td>
                         <?php echo $category['phone'];?>
                     </td>
                     <td>
                         <?php echo $category['address'];?>
                     </td>
                     <td>
                      <img src= "   <?php echo $category['photo'];?>" width="100px" hight="100px">
                     </td>
                     <td>
 ...
 <?php
            ...
            <form action="manager.php" method="POST">
                ...
                Photo:<input type="text" name="photo" id="photo" value="<?php echo $photo; ?>"/><br><br>

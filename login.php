...
$conn = mysqli_connect("localhost","root","","std");
    if(isset($_POST['submit']))
    {
      ...
      $stm= "SELECT * FROM users WHERE username='$username' AND email='$email' ";

      try{
         $result =  mysqli_query($conn,$stm)or die($mysqli->error());
         $rows = $result->fetch_array();
         if ($rows['username']) {
            $h_password=$rows['password'];
             // التحقق من كلمة المرور
             if (password_verify($password, $h_password)) {
               echo "<script>alert('تسجيل دخول ناجح , $username. ');</script>";
             } else {
                 echo "<script>alert('كلمة المرور غير صحيحة, $username. ');</script>";
             }
         } else {
            echo "<script>alert('الحساب غير موجود');</script>";
         }
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
               ...
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="about.html">registeration</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="services.html">log in</a>
                        </li>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital"><span style="color: #fcce2d">Registeration</span></h1>

            <div class="services_section_2">
               <div class="register_shutdown_function">
                  <form action="" class="form-control:focus " method="POST">
                  <table>
                        <tr><td>User Name:</td><td><input type="text" name="username"></td></tr>
                        <tr><td>Email:</td><td><input type="Email" name="email"></td></tr>
                        <tr><td>Password:</td><td><input type="password" name="password"></td></tr>
                        
                        <tr><td colspan="2"> <input type="submit" name="submit" value="register" class="submit"></td></tr>
                     </table>
                  </form>
               </div>
